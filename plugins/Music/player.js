...
exports.play = {
    description: "Plays a song followed by a <search term | url>.",
...
exports.skip = {
    description: "Skips current song that is playing.",
    process: function (bot, msg, suffix) {
        skip(msg, suffix);
    }
}
...
exports.queue = {
    description: "Checks the upcoming song queues.",
    process: function (bot, msg, suffix) {
        queue(msg, suffix)
    }
}
...
exports.clearqueue = {
    description: "Clears the queue on the bot.",
    process: function (bot, msg, suffix) {
